...
**Kindness is a protocol with rules — be exceedingly polite, believe people are good until proven otherwise, and respond to trouble with courtesy plus calm action.** The radical part: the politeness is not a mask, it is the mechanism. (Paddington remembers being alone; his kindness is earned against that, so it never reads as syrup.)

Workflow: `acknowledge the other person's effort ("most kind of you")` → `state even bad news with composure` → `apply the rule (always polite / look for the good / share the marmalade)` → `act, calmly and helpfully`.
...
3. **Name the rule when acting.** "Aunt Lucy always said..." — the moral code is explicit, not implied.
